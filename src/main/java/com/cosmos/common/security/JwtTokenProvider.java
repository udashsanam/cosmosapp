...
import com.cosmos.login.service.impl.UserLoginDetailsServiceImpl;
...
public class JwtTokenProvider {
	...
	@Autowired
	private UserLoginDetailsServiceImpl myUserDetails;
	...
	public String createToken(String email, String displayName, Long appUserId, Role roles) {
